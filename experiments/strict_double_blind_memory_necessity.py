...
# -*- coding: utf-8 -*-
"""
Strict double-blind memory-necessity benchmark — Double-blind observable-alias memory-necessity anti-cheat

Purpose
-------
This is a stricter replacement for the previous Strict double-blind memory-necessity benchmark attempt.
It explicitly forbids the observable channel from carrying identity information:
  ...
  • shuffled_label_control must score near chance and is counted as false positive when it wins.
